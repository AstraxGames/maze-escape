...
(function() {
    ...
    splashContainer.innerHTML = `
        ...
        <div id="ax-stage-1" class="ax-splash-stage">
            ...
            <p class="ax-presents-text">Presents</p>
        </div>

        <!-- Stage 2: The Game Title -->
    ...
    window.addEventListener('load', () => {
        ...
        // 0.5 seconds: Fade in AstraX Games Logo
        setTimeout(() => { 
            document.getElementById('ax-stage-1').classList.add('active'); 
        }, 500);

        // 3.5 seconds: Fade out AstraX Games Logo
        setTimeout(() => { 
            document.getElementById('ax-stage-1').classList.remove('active'); 
        }, 3500);

        // 4.5 seconds: Fade in "Maze Escape"
        setTimeout(() => { 
            document.getElementById('ax-stage-2').classList.add('active'); 
        }, 4500);

        // 7.5 seconds: Fade out "Maze Escape"
        setTimeout(() => { 
            document.getElementById('ax-stage-2').classList.remove('active'); 
        }, 7500);
        
        // 8.5 seconds: Fade out the entire black screen, revealing the game underneath!
        setTimeout(() => { 
